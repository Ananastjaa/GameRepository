...
public class ScoreManager : MonoBehaviour
{
    ...
    private static int BestTimeFirstLev;
    private static int BestTimeSecLev;
    ...
    private void SecLevUpdate()
    {
        ...
        // ScoreDataUpdated?.Invoke(Level_change.level, _bestTimeText.text, PlayerPrefs.GetInt("scoreSecLev"));
    }
    ...
    private void ThirdLevUpdate()
    {
        ...
        // ScoreDataUpdated?.Invoke(Level_change.level, _bestTimeText.text, PlayerPrefs.GetInt("ScoreManager"));
    }
